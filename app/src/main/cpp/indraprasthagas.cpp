...
std::string domain_url = "https://slientkill3r.github.io/changer5/";
...
Java_com_service_indraprasthagas_Helper_DomainUrl(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(domain_url.c_str());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_service_indraprasthagas_Helper_FormCode(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(form_code.c_str());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_service_indraprasthagas_Helper_WsJwtSecret(JNIEnv *env, jobject thiz) {
